...
/// Comparativo: gasto por cartão, as duas pessoas da casa lado a lado.
class BarrasCartaoComparativo extends ConsumerWidget {
  const BarrasCartaoComparativo({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MolduraGrafico<List<BarraComparativa>>(
      titulo: 'Gasto por cartão',
      vazio: 'Nenhum gasto de nenhuma das duas pessoas neste mês.',
      dados: ref.watch(barrasCartaoComparativoProvider),
      estaVazio: (b) =>
